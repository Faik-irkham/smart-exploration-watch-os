    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Sensor dibaca tiap detik; data dikirim tiap '
            '${state.intervalMinutes} menit.',
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: 10, color: Colors.grey[500]),
          ),
          ...
          FilledButton(
            onPressed:
                state.permanentlyDenied ? openAppSettings : cubit.requestAndStart,
            child: Text(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            'interval ${state.intervalMinutes} mnt',
            style: TextStyle(fontSize: 11, color: Colors.grey[500]),
          ),
          const SizedBox(height: 6),
          BleStatusIndicator(status: state.bleStatus, message: state.bleMessage),
